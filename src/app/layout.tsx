...
// Using system fonts with CSS fallbacks since no network access for Google Fonts
      ...
      <body className="font-body antialiased">
        ...
        <div className="floating-btn-bar md:hidden">
          <a
            ...
            className="flex-1 flex items-center justify-center gap-2 bg-[#E8601C] text-white py-4 font-semibold text-sm"
          >
            <svg
            ...
            >
              <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12 19.79 19.79 0 0 1 1.65 3.27a2 2 0 0 1 1.82-2.18h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z" />
            </svg>
            Contact Us
          </a>
          <a
            ...
            className="flex-1 flex items-center justify-center gap-2 bg-[#25D366] text-white py-4 font-semibold text-sm"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="18"
